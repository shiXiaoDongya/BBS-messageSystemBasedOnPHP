...
<body style="background-color:#CCC;">
    ...
    <div id="userinfo">
    	<div style="text-align:center;">
        	<span style="font-size:22px; cursor:pointer;" id="reg">注册</span>
            <span>&nbsp;&nbsp;&nbsp;丨&nbsp;&nbsp;&nbsp;</span>
            <span style="font-size:22px; cursor:pointer; text-decoration:underline;" id="log">登录</span>
        </div>
    	<form action="useradd.php" method="post" id="registerform" style="display:none;" onSubmit="return submitcheck()">
        ...
        <form action="logcheck.php" method="post" id="loginform" style="display:block;">
